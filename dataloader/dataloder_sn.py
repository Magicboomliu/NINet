...
from utils.file_io import read_img, read_disp,read_normal
...
class StereoDataset(Dataset):
    def __init__(self, data_dir,
        ...
        for line in lines:
            ...
            gt_normal = None if len(splits)<4 else splits[3]
            ...
            sample['gt_normal'] = os.path.join(data_dir,gt_normal) if gt_normal is not None else None
    ...
    def __getitem__(self, index):
        ...
        if sample_path["gt_normal"] is not None:
            sample['gt_normal'] = read_normal(sample_path['gt_normal']) #[H,W,3]
