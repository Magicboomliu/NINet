...
import sys
sys.path.append("../../..")
from networks.utilsNet.attention.SelfAttention import ScaledDotProductAttention

from networks.utilsNet.attention.SimplifiedSelfAttention import SimplifiedScaledDotProductAttention
...
if __name__ == '__main__':
    input=torch.randn(4,64,320,640)
    danet=DAModule(d_model=64,kernel_size=3,H=320,W=640)
