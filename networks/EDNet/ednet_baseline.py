...
class EDNet(nn.Module):
    def __init__(self, batchNorm=False, max_disp=192, input_channel=3, res_type='normal',
        ...
        elif self.res_type =='dilation1':
            residual = res_submodule_attention_dilation_simple
        elif self.res_type =='dilation2':
            residual = res_submodule_attention_dilation_simple
        else:
...
if __name__=="__main__":
    ...
    mynet = EDNet(res_type='dilation1').cuda()
    disp_pyramid = mynet(input_tensor,input_tensor,True)
