...
class EDNet(nn.Module):
    def __init__(self, batchNorm=False, max_disp=192, input_channel=3, res_type='normal',
        ...
        elif self.res_type =='error_norm':
            residual = res_submodule_surface_differ_dilation
        elif self.res_type =="simple_d":
            residual = res_submodule_surface_differ_Simple
...
if __name__=="__main__":
    ...
    mynet = EDNet(res_type="error_norm").cuda()
