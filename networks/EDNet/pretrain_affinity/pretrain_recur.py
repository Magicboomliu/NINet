...
class EDNet(nn.Module):
    ...
    def forward(self, img_left, img_right,assisted_normal,training=False):
        ...
        if self.res_type == 'deform_lstm':
            pr1,h1,c1 = self.res_submodule_1(img_left,img_right,pr1,cur_normal,iconv1,h=None,c=None)
        ...
        if self.res_type == 'deform_lstm':
            ...
            pr0,h0,c0 = self.res_submodule_0(img_left,img_right,pr0,cur_normal,iconv0,h=None,c=None)
        else:
