...
import torch.nn.functional as F
from networks.utilsNet.devtools import print_tensor_shape
from networks.EDNet.deform_aggregation import Normal_Guided_Aggregation,NGMFeature
...
class EDNet(nn.Module):
    def __init__(self, batchNorm=False, max_disp=192, input_channel=3, res_type='normal',
        ...
        elif self.res_type =='propagation':
            residual = res_submodule_NGMFeatureV2
        else:
    ...
    def forward(self, img_left, img_right,assisted_normal,training=False):
        ...
        # pr3 = self.affinity_propagation_list[0](cur_normal,img_left,img_right,pr3)
        ...
        # pr2 = self.affinity_propagation_list[1](cur_normal,img_left,img_right,pr2)
        ...
        # pr1 = self.affinity_propagation_list[2](cur_normal,img_left,img_right,pr1)
        ...
        # pr0 = self.affinity_propagation_list[3](cur_normal,img_left,img_right,pr0)
...
if __name__=="__main__":
    ...
    mynet = EDNet(res_type='propagation').cuda()
